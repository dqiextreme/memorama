...
namespace memorama
{
    public partial class Mem_Ctrl2 : UserControl
    {
        ...
        //--prueba
        Label L_Mov2 = new Label();
        public static int Grid_Size;// = 4;

        Form frm;

        public Mem_Ctrl2(int Gs)
        {
            InitializeComponent();
        ...
        private void methodinvoke()
        {
            if (frm != null)
            {
                ...
                par[0] = L_Mov2;
                frm.GetType().GetMethod("labl").Invoke(frm, par);
            }
        }
        ...
        private void btnCarta_Click(object sender, EventArgs e)
        {
            if (CartasSeleccionadas.Count < 2)
            {
                ...
                L_Mov2.Text = Convert.ToString(Movimientos);
                methodinvoke();
